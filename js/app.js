            ...
            <div class="w-1/2 md:w-1/3 lg:w-1/4 mb-4 p-3">
                <div class="bg-white ">
                    ...
                    <div class="p-4">
                        ...
                        target="_blank" class="bg-purple-700 w-full p-1 block mt-5 rounded text-center font-bold uppercase hover:bg-purple-800 text-white">Ver Imagen</a>
                    </div>
                </div>
            </div>
            `;
...
function mostrarPaginacion() {
    ...
    while( true ) {
        ...
        botonSiguiente.classList.add('siguiente', 'bg-purple-700', 'px-4', 'py-1', 'mr-2', 'mx-auto', 'mb-10', 'font-bold', 'uppercase', 'rounded', 'text-gray-100');
